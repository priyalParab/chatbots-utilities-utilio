...
## Project Goal
The goal is to make Utilio insightful, omni-channel compatible and supportive to purposeful automation.
...
**Note**: RASA starter pack should suffice to under the workings of a basic RASA bot
